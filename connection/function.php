...
// function _get_user_info($conn, $user_id){
...
// 	return '[{"transaction_id":"'.$transaction_id.'","fullname":"'.$fullname.'","loan_amount":"'.$loanamount.'","loan_duration":"'.$loanduration.'","transaction_date":"'.$transaction_date.'"}]';
// }
